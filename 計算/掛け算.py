...
LOG_FILE = "python/問題生成/計算/ログ/multiplication_log.json"
DEBUG = False
...
class MultiplicationQuizApp:
    ...
    def build_session_data(self, session_key):
        ...
        type_name = "デバッグ用" if DEBUG else "掛け算"
    ...
    def generate_problems(self, count=10, digits=3):
        ...
        while i < count:
            ...
            if DEBUG:
                print(f"デバッグ: 正解={correct_answer}")
            ...
            # 正誤判定
            is_correct = (int(correct_answer) == self.safe_int(user_answer)) or DEBUG
